                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل تيبثـون 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع عبودثون 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻--------"
                        ...
                        link = "[ܓܢܘܒ](https://t.me/IIIlllIlIIllI)"
                        text = (
                            "**✘ تقـريـر اشعـار عبودثون 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار عبودثون 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 ✘**\n\n "
                        link = "[ܓܢܘܒ](https://t.me/IIIlllIlIIllI)"
