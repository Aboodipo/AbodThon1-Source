...
# =========================================================== #
#                           الملـــف كتـــابـــة مـــن الصفـــر - T.me/AbodThon                           #
# =========================================================== #
...
# =========================================================== #
#                                      عبود الهيبـــه - T.me/IIIlllIlIIllI                                  #
# =========================================================== #


#Write Code By T.me/IIIlllIlIIllI
...
async def zelzal2(event):
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await event.client.send_file(
            event.chat_id,
            repo,
            caption=f"<b>⎉╎الريبـو :- <code>{zelzal}</code></b>\n<b>⎉╎تم التحميـل بواسطـة عبودثون :- @AbodThon</b>",
            parse_mode="html",
            reply_to=reply_id_,
        )
