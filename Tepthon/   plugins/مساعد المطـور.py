...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 - اوامــر المطـور المســاعد](t.me/AbodThon) 𓆪\n\n"
    ...
    "\n𓆩 [ 𝗔𝗯𝗼𝗼𝗱 - مطـور السـورس](t.me/TlOOIT) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت عبودثون 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت عبودثون 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
