...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗧𝗘𝗣𝗧𝗛𝗢𝗡 𓆪 </b> - @Tepthon "
    ...
    if x == 6:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗔𝗯𝗼𝗱𝗧𝗵𝗼𝗻 𓆪 </b> - @AbodThon "
...
async def who(event):
    ...
    if replied_user.id == 7616615251 or replied_user.id == 7616615251 or replied_user.id == 8143213185:
