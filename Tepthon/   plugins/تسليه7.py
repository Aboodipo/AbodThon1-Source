...
async def _(event):
    zel_dev = (7616615251, 7616615251, 7616615251, 7616615251, 7616615251, 7616615251, 7616615251, 1260465030, 7616615251, 7616615251, 7616615251, 7616615251, 7616615251, 7616615251, 8143213185, 8143213185, 8143213185, 8143213185, 7616615251)
    if event.reply_to_msg_id:
        ...
        if idd == 7616615251 or idd == 7616615251 or idd == 8143213185 or idd == 7616615251:
            ...
            animation_chars = [
                "**⌔: جاري الاتصال بخوادم عبودثون المتخصصه بالـتهكير**",
