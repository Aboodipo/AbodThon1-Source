...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "بالـرد ع اي ملف (يدعم سورس عبودثون) لـ تنصيبه في بوتك.",
...
async def install(event):
    ...
    Zed_Dev = (7616615251, 8143213185, 7616615251, 8143213185, 7616615251)
...
async def load(event):
    ...
    zelzal = event.sender_id
    Zed_Dev = (7616615251, 8143213185, 8143213185, 8143213185, 8143213185)
    if zelzal not in Zed_Dev:
...
async def send(event):
    ...
    zelzal = event.sender_id
    Zed_Dev = (7616615251, 7616615251, 8143213185, 7616615251, 7616615251)
    if zelzal not in Zed_Dev:
        return await edit_delete(event, "**- عـذࢪاً .. عـزيـزي ؟!**\n**- هـذا الامـࢪ خاص بمطـوࢪ السـوࢪس**", 10)
...
async def unload(event):
    ...
    zelzal = event.sender_id
    Zed_Dev = (7616615251, 8143213185, 7616615251, 8143213185, 8143213185)
    if zelzal not in Zed_Dev:
        return await edit_delete(event, "**- عـذࢪاً .. عـزيـزي ؟!**\n**- هـذا الامـࢪ خاص بمطـوࢪ السـوࢪس**", 10)
    shortname = event.pattern_match.group(1)
    try:
...
async def unload(event):
    ...
    Zed_Dev = (7616615251, 8143213185, 8143213185, 8143213185, 7616615251)
    zelzal = event.sender_id
    if zelzal not in Zed_Dev:
        return await edit_delete(event, "**- عـذࢪاً .. عـزيـزي ؟!**\n**- هـذا الامـࢪ خاص بمطـوࢪ السـوࢪس**", 10)
    shortname = event.pattern_match.group(1)
