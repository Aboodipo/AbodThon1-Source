...
zel_dev = (7616615251, 8143213185, 8143213185, 7616615251)
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 8143213185 or event.chat_id == 8143213185 or event.chat_id == 8143213185:
        ...
        if user.id == 8143213185 or user.id == 8143213185 or user.id == 8143213185:
