...
async def _(event):
    ...
    zed_dev = (7616615251, 8143213185, 7616615251, 8143213185)
    if user.id in zed_dev:
        await event.reply(f"أهلًا وسهلًا بك مطوراي    عبود - @AbodThon")


@zedub.on(events.NewMessage(pattern="/abu"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (8143213185, 8143213185, 8143213185, 8143213185)
    if user.id in zed_dev:
        await event.reply(f"أهلًا بك عزيزي  (عبودي) - @AbodThon")


@zedub.on(events.NewMessage(pattern="/منصب"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (7616615251, 8143213185, 8143213185, 8143213185)
    if user.id in zed_dev:
        await event.reply(f"مرحبًـا مطور مودي - @AbodThon")
        
        
@zedub.on(events.NewMessage(pattern="/mody"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (8143213185, 8143213185, 7616615251, 8143213185)
    if user.id in zed_dev:
...
async def _(event):
    user = await event.get_sender()
    zed_dev = (8143213185, 8143213185)
    if user.id in zed_dev:
        await event.reply(f"أهلًا بك عزيزي  (BiLaL) - @TlOOIT")
